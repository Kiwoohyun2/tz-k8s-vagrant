...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "kube-master" do |master|
    ...
    master.vm.network "public_network", bridge: "Realtek Gaming 2.5GbE Family Controller", ip: "192.168.0.100"
  ...
  (1..COUNTER).each do |i|
    config.vm.define "kube-node-#{i}" do |node|
        ...
        node.vm.network "public_network", bridge: "Realtek Gaming 2.5GbE Family Controller", ip: "192.168.0.10#{i}"
